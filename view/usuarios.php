...
<body>
	...
	<!-- Modal que Edita um novo usuario -->
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Editar Usuario Existente</h4>
				</div>
...
<!-- Script modal que Adiciona novos dados -->
<script type="text/javascript">
	...
	// Script modal que elimina um novo Usuário
