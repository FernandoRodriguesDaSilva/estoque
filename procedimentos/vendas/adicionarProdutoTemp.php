<?php 
	// tabela que adicionar itens temporarios em tabelaVendasTemp.php
session_start();
require_once "../../classes/conexao.php";

$c= new conectar();
$conexao=$c->conexao();
// recuperando a informações 
...
// informaçoes que será passadas pelos separadores
$produto=$idproduto."||".
$nomeproduto."||".
$descricao."||".
$preco."||".
...
$quantV * $preco."||".
$idcliente;
// aciona session do foreach que está em tabelaVendasTemp.php
